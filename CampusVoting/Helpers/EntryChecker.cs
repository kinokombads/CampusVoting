namespace CampusVoting.Helpers
{
    public static class EntryChecker
    {
        ...
        //public static bool IsNotNullOrWhiteSpace(string p1 )
        //{
        ...
        public static bool IsNotNullOrWhiteSpace(string p1, ref string msg)
        {
            if (!string.IsNullOrWhiteSpace(p1)) return true;
            msg = ErrorMessage2();
            return false;
        ...
        //public static bool IsNotNullOrWhiteSpace(string p1, string p2)
        //{
        ...
        public static bool IsNotNullOrWhiteSpace(string p1, string p2, ref string msg)
        {
            if (!(string.IsNullOrWhiteSpace(p1) && string.IsNullOrWhiteSpace(p2))) return true;
            msg = ErrorMessage2();
            return false;
        ...
        //public static bool IsNotNullOrWhiteSpace(string p1, string p2, string p3)
        //{
        ...
        public static bool IsNotNullOrWhiteSpace(string p1, string p2, string p3, ref string msg)
        {
            if (!(string.IsNullOrWhiteSpace(p1) && string.IsNullOrWhiteSpace(p2) && string.IsNullOrWhiteSpace(p3))) return true;
            msg = ErrorMessage2();
            return false;
        ...
        //public static bool IsNotNullOrWhiteSpace(string p1, string p2, string p3, string p4)
        //{
        ...
        public static bool IsNotNullOrWhiteSpace(string p1, string p2, string p3, string p4, ref string msg)
        {
            if (!(string.IsNullOrWhiteSpace(p1) && string.IsNullOrWhiteSpace(p2) && string.IsNullOrWhiteSpace(p3) && string.IsNullOrWhiteSpace(p4))) return true;
            msg = ErrorMessage2();
            return false;
        ...
        //public static bool IsNotNullOrWhiteSpace(string p1, string p2, string p3, string p4, string p5)
        //{
        ...
        public static bool IsNotNullOrWhiteSpace(string p1, string p2, string p3, string p4, string p5, ref string msg)
        {
            if (!(string.IsNullOrWhiteSpace(p1) && string.IsNullOrWhiteSpace(p2) && string.IsNullOrWhiteSpace(p3) && string.IsNullOrWhiteSpace(p4) && string.IsNullOrWhiteSpace(p5))) return true;
            msg = ErrorMessage2();
            return false;
